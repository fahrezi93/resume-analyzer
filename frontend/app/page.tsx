      ...
      <div className={`min-h-screen transition-all duration-500 ${isDarkMode ? 'bg-slate-900' : 'bg-orange-50'}`}>
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-12">
            <div className={`inline-flex items-center px-3 py-1.5 rounded-full ${isDarkMode ? 'bg-slate-800 text-orange-300' : 'bg-orange-100 text-orange-700'} mb-4`}>
          ...
          <div className="space-y-6">
            ...
            <div className={`relative p-6 rounded-2xl ${isDarkMode ? 'bg-white/5 border border-white/10' : 'bg-white/80 border border-white/30'} backdrop-blur-xl shadow-xl hover-lift`}>
              {/* Border Effect */}
              <div className="absolute inset-0 bg-orange-600 rounded-2xl opacity-20 blur-lg"></div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  {isDragActive ? (
                    <div className="text-orange-600">
                      ...
                      <p className="text-orange-500 mt-2 text-sm">Release to upload your resume</p>
                    </div>
                  ) : (
                    <div className={isDarkMode ? 'text-gray-300' : 'text-gray-600'}>
                      <div className="relative mb-6">
                        <div className="absolute inset-0 bg-orange-400 rounded-full blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-300"></div>
                        <div className="relative p-4 bg-orange-500 rounded-2xl mx-auto w-fit">
                      ...
                      <div className="flex justify-center gap-4 mb-6">
                        ...
                        <div className="flex items-center space-x-2 px-4 py-2 bg-slate-100 rounded-full">
                          <FileText className="w-4 h-4 text-slate-600" />
                          <span className="text-sm font-medium text-slate-700">DOCX</span>
                        </div>
                      </div>
                ...
                {/* File Preview */}
                {file && (
                  <div className="mt-8 p-6 bg-orange-50 rounded-2xl border border-orange-200 animate-slide-up">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <p className="font-bold text-orange-800 text-lg">{file.name}</p>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-orange-600 text-sm font-medium">Ready</span>
                      </div>
                    </div>
                  </div>
                )}
                ...
                <div className="mt-8">
                  <button
                    ...
                    className="group relative w-full p-6 bg-orange-600 rounded-2xl text-white font-bold text-xl overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none hover:bg-orange-700"
                  >
            ...
            {/* Error Display */}
            {error && (
              <div className="p-6 bg-orange-50 border border-orange-200 rounded-2xl animate-slide-up">
    ...
    <div className={`min-h-screen transition-all duration-500 ${isDarkMode ? 'bg-slate-900' : 'bg-orange-50'}`}>
            ...
            <div className="lg:col-span-5">
              <div className="relative">
                ...
                >
                  ...
                  <div className="absolute -top-4 -right-4 w-16 h-16 bg-orange-500 rounded-2xl flex items-center justify-center shadow-lg animate-bounce">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      {['Analisis Konten', 'Pencocokan Kata Kunci', 'Pembuatan Skor'].map((step, index) => (
                        <div key={index} className="flex items-center space-x-3">
                          <div className={`w-6 h-6 rounded-full flex items-center justify-center ${index <= currentStep ? 'bg-orange-500' : isDarkMode ? 'bg-white/10' : 'bg-gray-200'}`}>
                    ...
                    <div className={`p-4 rounded-xl ${isDarkMode ? 'bg-white/5' : 'bg-gray-50'}`}>
                      <div className="flex items-center space-x-2 mb-2">
                        <Eye className={`w-4 h-4 ${isDarkMode ? 'text-orange-400' : 'text-orange-600'}`} />
                      ...
                      <div className="h-20 bg-orange-100 rounded-lg flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <div className="h-2 bg-orange-300 rounded w-20 mx-auto"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {/* Floating Cards */}
                <div className="absolute -bottom-6 -left-6 p-4 bg-orange-500 rounded-2xl shadow-lg transform rotate-12 hover:rotate-6 transition-transform duration-300">
                  <Users className="w-6 h-6 text-white mb-2" />
                  <div className="text-white text-sm font-medium">10M+ Pengguna</div>
                </div>

                <div className="absolute -top-6 -left-8 p-3 bg-slate-500 rounded-xl shadow-lg transform -rotate-12 hover:-rotate-6 transition-transform duration-300">
      ...
      <div className="py-16 px-6" id="features">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-6 lg:grid-cols-8 gap-4 max-w-5xl mx-auto">
            {/* Large Feature Card */}
            <div className={`md:col-span-3 lg:col-span-4 p-6 rounded-2xl ${isDarkMode ? 'bg-slate-800 border border-white/10' : 'bg-orange-100 border border-orange-200'} hover-lift hover-glow group`}>
              ...
              <div className={`p-3 rounded-xl ${isDarkMode ? 'bg-white/5' : 'bg-white/70'} mb-3`}>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className={isDarkMode ? 'text-orange-400' : 'text-orange-600'}>85%</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={`md:col-span-3 lg:col-span-2 p-4 rounded-2xl ${isDarkMode ? 'bg-slate-800 border border-orange-500/20' : 'bg-orange-50 border border-orange-200'} hover-lift group`}>
              <div className="p-2 bg-orange-500 rounded-xl w-fit mb-3">
            ...
            <div className={`md:col-span-3 lg:col-span-2 p-4 rounded-2xl ${isDarkMode ? 'bg-slate-800 border border-orange-500/20' : 'bg-orange-50 border border-orange-200'} hover-lift group`}>
              <div className="p-2 bg-slate-500 rounded-xl w-fit mb-3">
              ...
              <div className="flex items-center space-x-2">
                <div className={`text-2xl font-bold ${isDarkMode ? 'text-orange-400' : 'text-orange-600'}`}>92</div>
                <div className="text-xs">
                  <div className={isDarkMode ? 'text-orange-400' : 'text-orange-600'}>Sangat Baik</div>
            ...
            {/* Bottom Row */}
            <div className={`md:col-span-2 lg:col-span-2 p-4 rounded-2xl ${isDarkMode ? 'bg-slate-800 border border-orange-500/20' : 'bg-orange-50 border border-orange-200'} hover-lift group`}>
              <div className="p-2 bg-slate-500 rounded-xl w-fit mb-3">
            ...
            <div className={`md:col-span-2 lg:col-span-3 p-4 rounded-2xl ${isDarkMode ? 'bg-slate-800 border border-orange-500/20' : 'bg-orange-50 border border-orange-200'} hover-lift group`}>
              <div className="p-2 bg-orange-500 rounded-xl w-fit mb-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className={`text-xs ${isDarkMode ? 'text-orange-400' : 'text-orange-600'}`}>Memproses...</span>
              </div>
            </div>

            <div className={`md:col-span-2 lg:col-span-1 p-4 rounded-2xl ${isDarkMode ? 'bg-slate-800 border border-orange-500/20' : 'bg-orange-100 border border-orange-200'} hover-lift group flex flex-col items-center justify-center text-center`}>
      ...
      <div className="relative py-20 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className={`absolute inset-0 ${isDarkMode ? 'bg-slate-900' : 'bg-orange-600'}`}></div>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <button 
              onClick={() => setShowAnalyzer(true)}
              className="group relative px-8 py-4 bg-white text-orange-600 rounded-xl font-display font-bold text-lg overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl"
            >
